...
<!--more-->
- - -
  这并不是自己所写，由于有时候忘记了markdown的语法，偶尔找找看看。有时候又懒得找，于是找来了markdown语法，方便与下次寻找。

文章来源:[markdown-syntax.md](https://gitcafe.com/riku/Markdown-Syntax-CN/raw/master/syntax.md "markdown-syntax.md") 
网址: [http://www.appinn.com/markdown/](http://www.appinn.com/markdown/ "markdown语法说明")
